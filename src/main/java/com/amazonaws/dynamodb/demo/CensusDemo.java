...
public class CensusDemo {
    ...
    private static final long TARGET_WRITE_RATE = 25000;
    private static final long PROVISIONED_READS = 100;
    private static final String TABLE_NAME = "SN-Census-Demo2";
    ...
    public static void main(String[] args) throws Exception {
        ...
        example.simulateTraffic(8, TimeUnit.HOURS);
    }

    private CensusDemo() {
        ClientConfiguration clientConfig = new ClientConfiguration()
                .withRetryPolicy(
                        PredefinedRetryPolicies.getDynamoDBDefaultRetryPolicyWithCustomMaxRetries(2))
        ...
        this.pool = new ThreadPoolExecutor(4, 200, 0, TimeUnit.MILLISECONDS, new LinkedBlockingDeque<>(200), new ThreadPoolExecutor.AbortPolicy());
    }
    ...
    private void simulateTraffic(long duration, TimeUnit timeUnit) {
        ...
        while (stopwatch.elapsed(timeUnit) < duration) {
            ...
            putItem(province, generatedString);
        }
    }
